      ...
      <main>
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-6">
                ...
                <h1 className="display-4 display-md-2 my-3">
                  <span className="bold">Dyaplock App</span>
                </h1>
                <p className="lead bold text-primary">The booking app</p>

                <p className="lead">
                  "Don't waste your time on a line. Use the dyaplock!"
                </p>

                <nav className="nav my-5">
                  <a
                    href="https://apps.apple.com/us/app/dyaplock/id1571355632"
                    className="btn btn-rounded btn-alternate mr-2"
                    target="_blank"
                    rel="noreferrer"
                  >
                    Download IOS
          ...
          <div className="container">
            ...
            <div className="row gap-y text-center text-md-left">
              <div className="col-md-4 py-4 rounded shadow-hover">
                ...
                <p className="">
                  Search dyaplock affiliated businesses nearby, conveniently
                  book appointments and leave a review.
                </p>
              </div>
              ...
              <div className="col-md-4 py-4 rounded shadow-hover">
                ...
                <p className="">
                  We seek to aid in the lowering of potential exposure by
                  allowing scheduled appointments.
                </p>
              </div>
              ...
              <div className="col-md-4 py-4 rounded shadow-hover">
                ...
                <p className="">
                  Professionals are able to create a business profile, showcase
                  their service list, prices and receive payments.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="col-md-6">
                <div className="section-heading">
                  ...
                  <p className="lead text-muted">
                    Dyaplock provides a service that creates efficiency when
                    customers seek to book appointments. Customers can
                    conveniently pick the time of request for service. Customer
                    can schedule appointments to the businesses nearby.
                    Customers can view ratings of shops. Business owners will
                    have the luxury of confirming these appointments and
                    providing coupons to their customers, ultimately making
                    their business tech. savvy and decrease the risk of covid.
                  </p>
                </div>
                ...
                <ul className="list-unstyled">
                  <li className="media flex-column flex-md-row text-center text-md-left">
                    ...
                    <div className="media-body mt-3 mt-md-0">
                      ...
                      <p className="m-0">
                        A one stop to all your search for capable professionals
                  ...
                  <li className="media flex-column flex-md-row text-center text-md-left mt-4">
                    ...
                    <div className="media-body mt-3 mt-md-0">
                      ...
                      <p className="m-0">
                        Tracking the status of an appointment or task to be done
                  ...
                  <li className="media flex-column flex-md-row text-center text-md-left mt-4">
                    ...
                    <div className="media-body mt-3 mt-md-0">
                      ...
                      <p className="m-0">
                        There is a realtime connection between you and your
                        professionals. You are never out of the loop
                      </p>
                    </div>
                  </li>
                </ul>
        ...
        <section className="section pricing-plans" id="pricing">
          <div className="shapes-container overflow-clear">
            ...
            <i
              className="icon far fa-credit-card fa-3x"
              data-aos="fade-down"
            ></i>
            <i
              className="icon far fa-money-bill-alt fa-3x"
              data-aos="fade-up"
            ></i>
          </div>
          ...
          <div className="container pb-8 bring-to-front">
            <div className="section-heading text-center">
              ...
              <p className="text-muted lead mx-auto">
                Dyaplock provides efficiency when customers seek to book
                appointments. Customers can interactively pick their preferred
                times for services. Customer can then schedule the appointment
                to the business nearby. Customers can view ratings of shops.
              </p>
            </div>
            ...
            <div className="row gap-y">
              <div className="col-md-6">
                <h4 className="bold text-alternate">
                  It all start by being on the right app
                </h4>
                <p className="text-muted lead mb-5">
                  When you're looking for the right professional for the job,
                  dyaplock is there to help.
                </p>
                  ...
                  <li className="list-item">
                    <div className="media align-items-center">
                      ...
                      <div className="media-body">
                        ...
                        <p className="my-0">
                          All profesionals around you in one place
                        </p>
                      </div>
                    </div>
                  </li>
                  ...
                  <li className="list-item">
                    <div className="media align-items-center">
                      ...
                      <div className="media-body">
                        ...
                        <p className="my-0">
                          The status of the task can easily be monitored
                        </p>
                      </div>
                    </div>
                  </li>
                  ...
                  <li className="list-item">
                    <div className="media align-items-center">
                      ...
                      <div className="media-body">
                        ...
                        <p className="my-0">
                          You have access to communicate with the professional
                          in realtime
                        </p>
                      </div>
                    </div>
                ...
                <div data-aos="fade-up">
                  <div className="card shadow-box shadow-hover mb-3">
                    ...
                    <div id="v1-q2" className="collapse card-body">
                      ...
                      it could take more or less time, however a standard time
                ...
                <div data-aos="fade-up">
                  <div className="card shadow-box shadow-hover mb-3">
                    ...
                    <div id="v1-q4" className="collapse card-body">
                      ...
                      represents any value to both we can include it as of a new
                      update. Please note it could take some time in order for
        ...
        <section className="section start-free" id="trial">
          ...
          <div className="container">
              ...
              <div className="col-md-6 mx-auto">
                <div className="section-heading text-center">
                  ...
                  <h2 className="heading-line bold mt-4">
                    Start your 60 days free trial for businesses now!
                  </h2>
                  <p className="lead text-muted">
                    There is a 60 day free trial, don’t miss this one time
                    introduction offer, billing will only commence after the
            ...
            <div className="nav flex-column flex-md-row align-items-center justify-content-center">
              ...
              <a
                href="mailto:dyaplock@gmail.com"
                ...
                <div className="rounded media bg-contrast shadow-lg p-4">
                  ...
                  <div className="media-body">
                    ...
                    <p className="mt-4">
                      ...
                      fret, our 24/7 geek team is ready to assistance you at no
                      extra cost.
                    </p>
                  </div>
                </div>
          ...
          <div className="row small">
            <div className="col-md-4">
              <p className="mt-2 mb-0 text-center text-md-left">
                ...
                <a href="https://dyaplock.com">Dyaplock</a>. All Rights Reserved
              </p>
            </div>
          </div>
        </div>
